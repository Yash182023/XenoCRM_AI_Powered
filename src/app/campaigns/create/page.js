          ...
          <div className="bg-white rounded-xl shadow-md overflow-hidden border border-slate-100">
            ...
            <div className="p-6 border-b border-slate-100">
              <div className="flex items-center mb-4">
                ...
                <h2 className="text-lg font-semibold text-slate-700">Campaign Details</h2>
              </div>
              <div>
                <label htmlFor="campaignName" className="block text-sm font-medium text-slate-700 mb-1">
                  Campaign Name
                </label>
                <input
                  type="text"
            ...
            <div className="p-6 bg-gradient-to-r from-blue-50 to-indigo-50 border-b border-slate-100">
              <div className="flex items-center mb-4">
                ...
                <h2 className="text-lg font-semibold text-slate-700">AI-Powered Audience Targeting</h2>
              </div>
              <div className="space-y-4">
                <div>
                  <label htmlFor="naturalLanguageQuery" className="block text-sm font-medium text-slate-700 mb-1">
            ...
            <div className="p-6 border-b border-slate-100">
              <div className="flex items-center mb-4">
                ...
                <h2 className="text-lg font-semibold text-slate-700">Campaign Objective</h2>
              </div>
                  ...
                  <ul className="space-y-2">
                    {messageSuggestions.map((suggestion, index) => (
                      <li key={index}
                        ...
                        <span className="text-sm text-slate-700 flex-grow mr-2">{suggestion}</span>
